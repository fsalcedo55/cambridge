  ...
  return (
    <div className="flex flex-col rounded-lg shadow">
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="flex items-center justify-between w-full px-4 py-3 text-sm font-medium text-left rounded-lg text-primary bg-primary/10 hover:bg-primary/25 focus:outline-none focus-visible:ring focus-visible:ring-primary-focus focus-visible:ring-opacity-75">
            ...
            <Disclosure.Panel className="px-4 pt-2 pb-2 text-sm text-base-content">
              <div className="flex justify-between">
                <div className="flex text-base-content"></div>
